...
DungenessTemperature <- grid.arrange(DungenessMinTemp, DungenessMaxTemp, DungenessMedianQTemp, ncol = 1, top = textGrob("Dungeness River Temperature Analysis", gp = gpar(fontsize = 16, fontface = "bold")))
...
ElwhaTrendsTemp <- grid.arrange(ElwhaReturns, ElwhaMinQ, ElwhaMaxQ, ElwhaMedianQ, ncol = 1, top = textGrob("Elwha Analysis", gp = gpar(fontsize = 16, fontface = "bold")))
```
