...
# creats a df of fish data. Originally, the code 1 chunk below this did this within its own workflow but I made it a seperate df bc i need it somewhere else, not attached to climate data
fish_data <-
  fish_files %>%
  lapply(read_csv) %>%
  bind_rows() %>%
