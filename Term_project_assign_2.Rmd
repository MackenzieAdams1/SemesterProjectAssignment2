...
```{r}
# With the help of Poole, this has been rewritten such that all the stream data is in one
# df. Can talk through the implications of this later. But is very nice
...
# NWIS_result <- readNWISdv(all_gages$site_no, para, start, end)
# saveRDS(NWIS_result, "NWIS_result.rdata")

gage_data <-
  readRDS("NWIS_result.rdata") %>%
  renameNWISColumns() %>%
  inner_join(all_gages, .) %>%
